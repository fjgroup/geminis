 ...
 *
 * Controlador de usuarios para administradores en arquitectura hexagonal
...
class AdminUserController extends Controller
{
    ...
    public function show(User $user): Response
    {
        ...
        $stats = $this->userManagementService->getUserStats($user);
    ...
    {
        try {
            $success = $this->userManagementService->toggleUserStatus($user);
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        try {
            $users = $this->userManagementService->searchUsers($criteria, $limit);
    ...
    public function resetPassword(Request $request, User $user): JsonResponse
    {
        ...
        try {
            $result = $this->userManagementService->changePassword($user, $request->new_password);
