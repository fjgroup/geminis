  ...
  <AdminLayout :title="'Editar Servicio de Cliente #' + clientService.id">
    ...
    <template #header>
      <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
        ...
        <span
          v-if="clientService.domain_name"
    ...
    <div class="py-12">
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div
          class="p-6 overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg md:p-8"
        >
          <ClientServiceForm
            :form="form"
          ...
          <div
            v-if="clientService.status === 'provisioning_failed'"
          ...
          >
            ...
            >
              ...
              <PrimaryButton
                @click="confirmRetryProvisioning"
