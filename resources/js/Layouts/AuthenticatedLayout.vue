              ...
              <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <template v-if="$page.props.auth.user && $page.props.auth.user.role === 'client'">
                  ...
                  <NavLink
                    ...
                    :active="
                      route().current('client.invoices.index') ||
                      route().current('client.invoices.show')
                    "
                  >
                    Facturas
                  </NavLink>
                ...
                <template v-if="$page.props.auth.user && $page.props.auth.user.role === 'reseller'">
                  <NavLink
                    ...
                    :active="
                      route().current('reseller.clients.index') ||
                      route().current('reseller.clients.create') ||
                      route().current('reseller.clients.edit') ||
                      route().current('reseller.clients.show')
                    "
                  >
                    My Clients
                  </NavLink>
                ...
                <template v-if="$page.props.auth.user && $page.props.auth.user.role === 'admin'">
                  ...
                  <NavLink
                    ...
                    :active="
                      ...
                      route().current('admin.products.show')
                    "
                  >
                    Manage Products
                  </NavLink>
                  ...
                  <NavLink
                    ...
                    :active="
                      route().current('admin.client-services.index') ||
                      route().current('admin.client-services.show')
                    "
                  >
                    Client Services
                  </NavLink>
